...
/* Aucun mock de banque : la page ne lit plus aucun relevé. Elle a porté un bloc
   « ce mois-ci » qui en demandait deux (comptes et opérations) ; ce bloc est
   reparti sur la page Cashflow, qui le teste chez elle. */
